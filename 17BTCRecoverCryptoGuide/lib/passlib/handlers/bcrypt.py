...
from lib.passlib.exc import PasslibHashWarning, PasslibSecurityWarning, PasslibSecurityError
from lib.passlib.utils import safe_crypt, repeat_string, to_bytes, parse_version, \
...
from lib.passlib.utils.compat import u, uascii_to_str, unicode, str_to_uascii
...
class _BuiltinBackend(_BcryptCommon):
    ...
    @classmethod
    def _load_backend_mixin(mixin_cls, name, dryrun):
        from lib.passlib.utils import as_bool
        ...
        from lib.passlib.crypto._blowfish import raw_bcrypt as _builtin_bcrypt
        return mixin_cls._finalize_backend_mixin(name, dryrun)
