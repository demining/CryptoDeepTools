...
from lib.passlib.utils.compat import PYPY, u, bascii_to_str
from lib.passlib.utils.decor import classproperty
from lib.passlib.tests.utils import TestCase, skipUnless, TEST_MODE, hb
# subject
from lib.passlib.crypto import scrypt as scrypt_mod
# local
__all__ = [
    "ScryptEngineTest",
    "BuiltinScryptTest",
...
class ScryptEngineTest(TestCase):
    ...
    def test_smix(self):
        """smix()"""
        from lib.passlib.crypto.scrypt._builtin import ScryptEngine
        rng = self.getRandom()
