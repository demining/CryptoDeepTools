...
# site
# pkg
from lib.passlib.handlers.bcrypt import _wrapped_bcrypt
from lib.passlib.hash import argon2, bcrypt, pbkdf2_sha1, pbkdf2_sha256
from lib.passlib.utils import to_unicode, rng, getrandstr
...
def _import_des_crypt():
    ...
    if des_crypt is None:
        from lib.passlib.hash import des_crypt
    return des_crypt
